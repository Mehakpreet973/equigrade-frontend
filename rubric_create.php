...
<body class="bg-gray-50 font-sans leading-normal tracking-normal">
    ...
    <div class="max-w-4xl mx-auto mt-12 bg-white rounded-2xl shadow-lg p-8">
        ...
        <form method="POST" onsubmit="return prepareCriteriaJSON();" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Criteria Builder</label>
                ...
                <button type="button" onclick="addRow()" class="mt-2 bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-sm">➕ Add Criterion</button>
                <p class="text-gray-500 text-xs mt-2">Total weight must equal 100 %. Example: Content 40 + Structure 30 + Research 30 = 100</p>
            </div>
